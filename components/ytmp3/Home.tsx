...
import { yt2mp3Url } from '../../EzCalc.config';
        ...
        <div className="min-h-screen flex flex-col items-center justify-center">
            <div className='w-full bg-zinc-900 text-white '>
                <div className="pt-6 text-center flex justify-center items-center">
                    ...
                    &nbsp;EzCalc is a Free, Safe, Easy-to-use YouTube to MP3 Converter.
                </div>
                <div className='flex justify-center items-center space-x-2 mb-2'>
                    ...
                    <a className='bg-red-400 text-white rounded-md px-2 py-1 mx-2 text-lg underline hover:bg-red-500 transition'
                        href="https://EzCalcccyoutubetomp3.quora.com/?invite_code=wJ55ugDw4sbNAOAAmIRs" target='_blank'>
                        Quaro Space
                    </a>
                </div>
                    ...
                    <main className="w-full flex-1 flex flex-col items-center px-4">
                        ...
                        <div className="mt-8 w-full max-w-2xl text-gray-600 mt-20">
                            ...
                            <p className="mb-4 leading-8">
                                Welcome to EzCalc, your ultimate online tool for converting YouTube to MP3 effortlessly!
