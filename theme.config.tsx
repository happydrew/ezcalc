...
const logo = (
  <div className="flex justify-center items-center" title="AutoFormAI">
    <Image src="/favicon.png" alt="EzCalc | Calculate anything " width={40} height={40} />
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex justify-between flex-wrap gap-10">
        <p className="text-sm">
          Copyright © {new Date().getFullYear()} EzCalc. All
          rights reserved.
          {/* <br />
...
const config: DocsThemeConfig = {
  ...
  head: function useHead() {
    ...
    const title = `${pageTitle}${path === "/" ? "" : " | EzCalc-Easy YouTube to MP3"}`
